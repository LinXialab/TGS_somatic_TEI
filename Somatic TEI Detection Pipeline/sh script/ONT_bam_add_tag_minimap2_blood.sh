...
(/biosoft/samtools-1.9/samtools view -H "$bam_sort"; /biosoft/samtools-1.9/samtools view "$bam_sort"|awk 'BEGIN{OFS="\t"}{$1="blood"$1; print $0}')|/biosoft/samtools-1.9/samtools view -S -b - -o "$bam_sort_tag"
